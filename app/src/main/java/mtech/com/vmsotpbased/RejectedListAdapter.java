...
//    private final Integer[] imgid;
    ...
    public RejectedListAdapter(Activity context, ArrayList<String> day, ArrayList<String> month,
                               ArrayList<String> totime, ArrayList<String> purpose, ArrayList<String> visitorname, ArrayList<String> Id) {
        super(context, R.layout.rejectedlist, day);
    ...
    public View getView(final int position, View view, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.rejectedlist, null, true);
