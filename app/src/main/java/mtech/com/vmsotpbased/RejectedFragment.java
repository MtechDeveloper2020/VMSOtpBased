...
public class RejectedFragment extends Fragment {
    ...
    RejectedListAdapter adapter = null;
        ...
        try {
            if (flag.equalsIgnoreCase("E")) {
                try {
                    ...
                    adapter = new RejectedListAdapter(getActivity(), day, month, totime, purpose, visitorName,Id);
                ...
                if (conn == null) {
                    ...
                    if (flag.equalsIgnoreCase("E")) {
                        String query = "SELECT VA.Id,VA.VisitorName,VA.Purpose,VA.AcDate,VS.Email FROM VisitorAppointment AS VA  \n" +
                                ...
                                "AND VA.checkAppointment='3' ORDER BY VA.Id DESC ";
