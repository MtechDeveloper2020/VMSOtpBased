...
/**
 * Created by cd02407 on 6/9/2018.
 */

public class Visitor_Register extends Activity {
    ...
    public void login(View v){
        Intent i = new Intent(this, VisitorLogin.class);
        startActivity(i);
        finish();
    }
    ...
    public class GetLongLat extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute(){
            progressDialog = new ProgressDialog(Visitor_Register.this);
